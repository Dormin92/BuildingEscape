...
var Module = {
	...
	UE4_indexedDBVersion: 201910141815, // Bump this number to invalidate existing IDB storages in browsers.
};
...
$(document).ready(function() {
	...
	function withIndexedDB(db) {
		...
		// ----------------------------------------
		// MAIN JS
		var mainJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('BuildingEscape-HTML5-Shipping.js')).then(function(data) {
